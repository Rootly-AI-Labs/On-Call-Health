...
app.include_router(github.router, prefix="/api/integrations", tags=["github-integration"])
app.include_router(slack.router, prefix="/api/integrations", tags=["slack-integration"])
app.include_router(jira.router, prefix="/api/integrations", tags=["jira-integration"])
